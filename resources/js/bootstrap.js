...
// });
// window.Echo.join("admin-notifications")
//     .here((users) => console.log("Currently online:", users))
//     .joining((user) => console.log("User joined:", user))
//     .leaving((user) => console.log("User left:", user))
//     .listen("PostCreated", (e) => console.log("Post created:", e));
...
window.Echo = new Echo({
    broadcaster: "pusher",
    key: "bd4878096f381ecaffd7",
    cluster: "mt1",
    forceTLS: true,
});

var channel = Echo.channel("admin-notifications");
channel.listen(".PostCreated", function (data) {
